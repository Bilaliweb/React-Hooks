...
//   }
  ...
  return (
    <div id="number">
      ...
      <button className='button' onClick={increaseNumber} disabled={onLastNumber}>{props.button1}: {state}</button>
      <button className='button' onClick={decreaseNumber} disabled={onFirstNumber}>{props.button2}: {state}</button>
    </div>
  );
}
